/**
 * The `Greater` number object represents the primitive value greater than the given.
 */
export class Greater<Value extends number> extends Number {
  ...
  /**
   * Checks whether the primitive value of a specified object is greater than every given value.
   * @param values A rest parameter of the numbers to test.
   * @returns The return value is a `boolean` indicating whether the primitive value is greater than every given value.
   * @angularpackage
   */
